...
pub(super) struct AuthStorageConfig {
    codex_home: PathBuf,
...
pub(super) fn create_auth_storage(config: AuthStorageConfig) -> Arc<dyn AuthStorageBackend> {
    let AuthStorageConfig {
        codex_home,
        mode,
        keyring_store,
        keyring_backend_kind,
